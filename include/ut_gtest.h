...
/**
 * @brief Macro to add a test case to a test fixture.
 *
 * This macro is used to define a test case within a test fixture using Google Test framework.
 *
 * @param test_case_name The name of the test fixture class.
 ...
 * @endcode
 */
#define UT_ADD_TEST(test_case_name, test_name) TEST_F(test_case_name, test_name)
