...
static char      f_szDefaultFileRoot[] = "UTAutomated";  /**< Default filename root for automated output files. */
                                                    ...
                                                    const CU_pFailureRecord pFailure)
{
  ...
  const char *pPackageName = UT_automated_package_name_get();
 ...
 */
CU_ErrorCode UT_automated_list_all_tests(CU_pTestRegistry pRegistry, const char* szFilename)
{
  ...
  if (NULL == pRegistry) {
    ...
    fprintf(stdout,"Listing All Tests To: [%s]",f_szTestListFileName);
 ...
 */
void UT_automated_enable_junit_xml(CU_BOOL bFlag)
{
 ...
 */
void UT_automated_package_name_set(const char *pName)
{
 ...
 */
const char *UT_automated_package_name_get()
{
