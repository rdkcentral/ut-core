...
|9|make TARGET=arm64|none (host toolchain)|builds ut-core for target arm64 (C and CPP variants)
|10|make -C tests/ TARGET=arm64|none (host toolchain)|builds ut-core tests for target arm64 (C and CPP variants)
...
# With ARM64 toolchain at default path:
./release-test-script-ut-core.sh -t <BRANCH_NAME>
# With ARM64 toolchain at a custom path:
