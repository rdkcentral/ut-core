...
SRC_DIRS += $(LIBWEBSOCKETS_DIR)/lib/core-net/client/client.c
SRC_DIRS += $(LIBWEBSOCKETS_DIR)/lib/core-net/client/connect.c
SRC_DIRS += $(LIBWEBSOCKETS_DIR)/lib/core-net/client/connect2.c
SRC_DIRS += $(LIBWEBSOCKETS_DIR)/lib/core-net/client/connect3.c
SRC_DIRS += $(LIBWEBSOCKETS_DIR)/lib/core-net/client/connect4.c
SRC_DIRS += $(LIBWEBSOCKETS_DIR)/lib/core-net/client/sort-dns.c
SRC_DIRS += $(LIBWEBSOCKETS_DIR)/lib/core-net/client/conmon.c
